...
# define the task named unzip_data
...
# define the task named extract_data_from_csv
...
# define the task named extract_data_from_tsv
extract_data_from_tsv = BashOperator(
    task_id='extract_data_from_tsv',
    bash_command = "cut -d$'\t' -f5-7 /home/project/airflow/dags/finalassignment/tollplaza-data.tsv | sed 's/\t/,/g' > /home/project/airflow/dags/finalassignment/tsv_data.csv",
    dag=dag,
)

# define the task named extract_data_from_fixed_width
...
# define the task named consolidate_data
